...
<div class="card-body">
 ...
 <div class="mt-3">
  ...
  <components-reports-earnings
    ...
    :label="{    
	    total_count : '<?php echo CommonUtility::safeTranslate("Count");?>',    
	    admin_earning : '<?php echo CommonUtility::safeTranslate("Admin earned");?>',    
	    merchant_earning : '<?php echo CommonUtility::safeTranslate("Merchant earned");?>',    
	    total_sell : '<?php echo CommonUtility::safeTranslate("Total sell");?>',    	    
	}"            
 />
 </components-reports-earnings>    
 ...
 <components-datatable
  ...
  :settings="{
      ...
      all_transaction : '<?php echo CommonUtility::safeTranslate("All status")?>'
    }"  
