...
"
                  ...
                  <q-item-section side class="row items-stretch" top>
                    <div class="column items-center col-12 q-gutter-y-md">
                      ...
                      <div class="col">
                        <q-btn
                          v-if="AccessStore.hasAccess('booking.room_delete')"
                          round
                          ...
                          unelevated
                          @click.stop="
                            deleteItems(item.room_uuid, items, index)
                          "
                        >
                        </q-btn>
                      </div>
...
export default {
  ...
  methods: {
    ...
    List(index, done) {
      this.loading = true;
      APIinterface.fetchDataByTokenPost("tableRoomList", "&page=" + index)
        .then((data) => {
          if (data.code == 1) {
            this.page = index;
