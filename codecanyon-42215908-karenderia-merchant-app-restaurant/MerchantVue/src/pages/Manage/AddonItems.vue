...
export default {
  ...
  mounted() {
    this.MenuStore.page_title = this.$t("Addon Items");

    if (this.DataStore.dataList?.addonitems) {
      this.data = this.DataStore.dataList?.addonitems?.data;
      this.page = this.DataStore.dataList?.addonitems?.page;
      this.hasMore = this.DataStore.dataList?.addonitems?.hasMore;
    } else {
      setTimeout(() => {
  ...
  beforeUnmount() {
    this.DataStore.dataList.addonitems = {
      data: this.data,
      page: this.page,
  ...
  methods: {
    async setAvailable(value) {
      try {
        ...
        await APIinterface.fetchDataByTokenPost("setAddonStatus", params);
      } catch (error) {
    ...
    async afterConfirm() {
      try {
        ...
        await APIinterface.fetchDataByTokenPost("deleteAddonItem", params);
